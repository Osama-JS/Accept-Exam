    ...
    public function array(): array
    {
        ...
        foreach ($query as $row) {
            $rows[] = [
                ...
                $row->student->name,
                $row->exam->grade->name,
                $row->student->previous_school ?? 'غير محدد',
                $row->student->last_grade_average ? $row->student->last_grade_average . '%' : 'غير محدد',
                $row->student->guardian_name ?? 'غير محدد',
                $row->student->guardian_phone ?? 'غير محدد',
                $row->exam->title,
